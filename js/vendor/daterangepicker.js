...
(function(root, factory) {
  ...
  var DateRangePicker = function(element, options, cb) {
    ...
    var DRPTemplate = '\n\n' +
			'\n<div id="date-range-picker" class="dropdown-popup daterangepicker">' +
			'\n\t<div class="dropdown-header range_actions">' +
			'\n\t\t<button class="text-only primary pull-right applyBtn"></button>' +
			'\n\t\t<button class="text-only cancelBtn"></button>' +
			'\n\t</div>' +
			'\n\n' +
			'\n\t<div id="date-range" class="dropdown-content ranges">' +
			'\n\t\t<div class="range_inputs">' +
			'\n\t\t\t<div id="fieldset-range-inputs" class="fieldset">' +
			'\n\t\t\t\t<div class="daterangepicker_start_input">' +
			'\n\t\t\t\t\t<label for="daterangepicker_start"></label>' +
			'\n\t\t\t\t\t<input type="text" name="daterangepicker_start" value="" />' +
			'\n\t\t\t\t</div>' +
			'\n\n' +
			'\n\t\t\t\t<span class="label above-field">to</span>' +
			'\n\n' +
			...
			'\n\t\t\t</div>' +
			'\n\n' +
			'\n\t\t\t<div id="fieldset-range-calendars" class="fieldset">' +
    ...
    //event listeners
		...
		this.container.find('.range_actions')
  ...
  DateRangePicker.prototype = {
      ...
      if (typeof options.ranges === 'object') {
        for (range in options.ranges) {
          ...
          this.ranges[range] = [start, end];
				...
				var list = '\n\n' +
					'\n\t<div class="fieldset dropdown-field full-width">' +
					'\n\t\t<button class="button dropdown-button full-width primary">Custom Range</button>' +
					'\n\t\t<div class="dropdown-popup outline full-width">' +
					'\n\t\t\t<ul id="date-range-presets" class="button-list">';

				for (range in this.ranges) {
					list += '\n\t\t\t\t<li class="button outline full-width">' + range + '</li>';
					}

				list += '\n' +
					'\n\t\t\t\t<li class="button outline full-width">' + this.locale.customRangeLabel + '</li>'
					'\n\t\t\t</ul>' +
					'\n\t\t</div>' +
					'\n\t</div>';
    ...
    toggle: function(e) {
      if (this.element.hasClass('drp-active')) {
        this.hide();
      } else {
        this.show();
      }
    ...
    show: function(e) {
      ...
      this.element.addClass('drp-active');
      this.container.show();
      this.move();
    ...
    hide: function(e) {
      ...
      this.element.removeClass('drp-active');
      this.container.hide();
